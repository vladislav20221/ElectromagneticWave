...
/**
 * Рамка для модели H волны
 * @author Vladislav
 */
class border_H_wave implements Border, Serializable {
    private final Color colorCentr = new Color ( 255, 216, 216 );
    private final Color colorOuterPart = new Color ( 255, 216, 216, 70 );
